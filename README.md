...
<!-- 🔲 실제 겪은 이슈와 해결 과정을 적어주세요. 예시 형식만 남겨둡니다. -->
 
<details>
<summary><b>예) 세션 인증에서 JWT 인증으로의 전환</b></summary>
- **문제** : `<!-- 어떤 문제가 있었는지 -->`
- **원인** : `<!-- 원인 분석 -->`
- **해결** : `<!-- 해결 방법 -->`
</details>
<details>
<summary><b>예) WebSocket 채팅 연결/재연결 이슈</b></summary>
- **문제** : `<!-- 입력 -->`
- **해결** : `<!-- 입력 -->`
</details>
<br/>
...
- [ ] 세션 기반 인증 → **JWT 인증** 전환 마무리
- [ ] Thymeleaf 잔여 화면의 **React 마이그레이션** 완료
- [ ] 채팅 알림 / 읽음 처리 고도화
- [ ] 이미지 업로드 최적화 및 성능 개선
- [ ] `<!-- 추가 목표 입력 -->`
<br/>
